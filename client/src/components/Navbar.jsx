    ...
    <div className="flex flex-row items-center sm:justify-between gap-6 sm:gap-4">
      <div className="flex flex-row gap-6 sm:gap-8 w-full">
        ...
        <div className="flex flex-row w-full">
          ...
          <Link to={{ 
            ...
            <button className="w-10 h-full bg-blue-600 rounded-r-lg text-white text-sm"><i className="fa-solid fa-magnifying-glass"></i></button>
          </Link>
        </div>
      </div>
      <ul className="hidden md:flex flex-row items-center gap-6">
        ...
        <div className="group relative">
          <li className="w-8 h-8"><img src="/user.png" alt="profile" className="h-full"/></li>
      ...
      <button className="flex md:hidden text-2xl" onClick={() => setMenuOpen(true)}><i className="fa-solid fa-bars"></i></button>
      <div className={'absolute flex-col items-center md:hidden w-[60%] h-full z-[999] top-0 right-0 gap-8 animate-open-menu text-white glass-menu '+ (menuOpen ? 'flex' : 'hidden')}>
        <div className="w-full pt-4 flex flex-row items-center content-center justify-center">
          <p className="text-xl">Menu</p>
          <button className="flex items-center absolute right-8" onClick={() => setMenuOpen(false)}><i className="fa-solid fa-x text-xl"></i></button>
        </div>
