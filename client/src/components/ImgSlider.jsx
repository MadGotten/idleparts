...
const ImgSlider = () => {
  return (
    <div className="w-full min-w-[20rem] relative grid bg-slate-400  h-40 sm:h-64 lg:h-96 p-2 rounded-lg bg-cover bg-center" style={{ backgroundImage: `url(${bannerUrl}` }}>
